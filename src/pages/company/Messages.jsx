...
const CompanyMessages = () => {
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      ...
      await addDoc(messagesRef, {
        ...
        senderName: userData?.companyName || 'Company',
  ...
  const getOtherParticipant = (conversation) => {
    ...
    // For now we rely on stored display name
    return conversation.otherParticipantName || otherUserId || 'Candidate';
  };
    ...
    <div className="flex flex-col h-full">
      <div className="mb-6">
        ...
        <p className="text-secondary-600 text-lg">
          Communicate with applicants and manage all conversations in one place.
        </p>
      </div>
          ...
          <div className="flex-grow card bg-white flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-secondary-500 text-sm mt-2">
                {conversations.length === 0
                  ? 'No conversations yet. Replies from candidates will appear here.'
